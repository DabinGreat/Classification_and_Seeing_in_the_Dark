...
class ConvLSTM(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, kernel_size, num_layers,
                 batch_size, seq_len, input_size, num_class,
        ...
        self.fc = nn.Linear(seq_len*hidden_dim*input_size[0]*input_size[1],num_class)
...
if __name__ == '__main__':
    ...
    convlstm = ConvLSTM(input_dim=4, hidden_dim=4, kernel_size=(3,3), num_layers=4,
                 batch_size=3, seq_len=2, input_size=(128,128), num_class=101,
                 batch_first=False, bias=True, return_all_layers=False)
    # _, last_states = convlstm(x)
    h = convlstm(x)
    print(h.size())